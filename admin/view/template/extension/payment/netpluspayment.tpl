...
<div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <select name="netpluspayment_payment_failure_status_id" id="input-order-status" class="form-control">
                ...
                <option value="<?php echo $order_status['order_status_id']; ?>" <?php if ($order_status['name']=='Failed') echo 'selected="selected"'; ?>><?php echo $order_status['name']; ?></option>
                <?php } ?>
              </select>
            </div>
          </div>
       <div class="form-group">
            ...
            <div class="col-sm-10">
               ...
               <select name="netpluspayment_payment_success_status_id" id="input-order-status" class="form-control">
                ...
                <option value="<?php echo $order_status['order_status_id']; ?>" <?php if ($order_status['name']=='Processed') echo 'selected="selected"'; ?>><?php echo $order_status['name']; ?></option>
